let add = document.getElementById('add');
         add.addEventListener('click',function(){
           if(document.getElementById('input_task').value!=""){
            ...
            p.innerHTML='<span>'+input_task+'</span>'+'<i class="fas fa-edit"></i>'+'<i class="fas fa-trash-alt"></i>'+'</br>'+'</br>'+' <i class="far fa-heart"></i>'+'<i class="far fa-comment"></i>'+'<i class="far fa-share-square"></i>'
